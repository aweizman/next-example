...
import { normalizeMoney, normalizeUpperCase, normalizeNumeric, normalizeNumericDecimal, normalizeNumericDecimalWithNegatives, normalizeNumericHyphen, normalizeParseInt, normalizeFeid, normalizeZip, normalizePhone } from './normalizations'
...
describe('normalizations has', () => {
  describe('normalizeMoney that', () => {
    ...
    it('returns', () => {
      ...
      expect(normalizeMoney(' ')).toEqual('0.00')
